                  ...
                  <li class="list-group-item">
                    <div class="row align-items-center">
                      <div class="col-4 col-md-3 col-xl-2">
                        ...
                        <!-- Image -->
                        <a href="product.html"><img src="{{ asset('client/assets/img/products/product-6.jpg')}}" alt="..." class="img-fluid"></a>
                  ...
                  <li class="list-group-item">
                    <div class="row align-items-center">
                      <div class="col-4 col-md-3 col-xl-2">
                        ...
                        <!-- Image -->
                        <a href="product.html"><img src="{{ asset('client/assets/img/products/product-10.jpg')}}" alt="..." class="img-fluid"></a>
                  ...
                  <li class="list-group-item">
                    <div class="row align-items-center">
                      <div class="col-4 col-md-3 col-xl-2">
                        ...
                        <!-- Image -->
                        <a href="product.html"><img src="{{ asset('client/assets/img/products/product-48.jpg')}}" alt="..." class="img-fluid"></a>
