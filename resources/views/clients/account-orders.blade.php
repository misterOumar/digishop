                ...
                <div class="col-12 col-lg-6">
                  <div class="row gx-5 mb-4 mb-lg-0">
                    <div class="col-3">
                      ...
                      <!-- Image -->
                      <div class="ratio ratio-1x1 bg-cover" style="background-image: url({{ asset('client/assets/img/products/product-5.jpg')}});"></div>

                    </div>
                    <div class="col-3">

                      <!-- Image -->
                      <div class="ratio ratio-1x1 bg-cover" style="background-image: url({{ asset('client/assets/img/products/product-122.jpg')}});"></div>

                    </div>
                    <div class="col-3">

                      <!-- Image -->
                      <div class="ratio ratio-1x1 bg-cover" style="background-image: url({{ asset('client/assets/img/products/product-7.jpg')}});"></div>
                ...
                <div class="col-12 col-lg-6">
                  <div class="row gx-5">
                    <div class="col-6">
                      ...
                      <!-- Button -->
                      <a class="btn btn-sm w-100 btn-outline-dark" href="{{ route('client.account.order.details') }}">
                        Order Details
                      </a>
                ...
                <div class="col-12 col-lg-6">
                  <div class="row gx-5 mb-4 mb-lg-0">
                    <div class="col-3">
                      ...
                      <!-- Image -->
                      <div class="ratio ratio-1x1 bg-cover" style="background-image: url({{ asset('client/assets/img/products/product-11.jpg')}});"></div>
                ...
                <div class="col-12 col-lg-6">
                  <div class="row gx-5 mb-4 mb-lg-0">
                    <div class="col-3">
                      ...
                      <!-- Image -->
                      <div class="ratio ratio-1x1 bg-cover" style="background-image: url({{ asset('client/assets/img/products/product-14.jpg')}});"></div>

                    </div>
                    <div class="col-3">

                      <!-- Image -->
                      <div class="ratio ratio-1x1 bg-cover" style="background-image: url({{ asset('client/assets/img/products/product-15.jpg')}});"></div>
