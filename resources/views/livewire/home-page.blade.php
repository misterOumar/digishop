                    ...
                    <div>
                        ...
                        <div class="flickity-buttons-lg flickity-buttons-bottom-start px-lg-12"
                            ...
                            @forelse ($categories as $category)
                                <div class="col px-4" style="max-width: 200px;" wire-key="{{ $category->id }}">
                                    <div class="card h-100">

                                        <!-- Image -->
                                        <img class="card-img-top" src="{{ asset('storage/' . $category->cover) }}"
                                            alt="...">
                                        ...
                                        <div class="card-body py-4 px-0 text-center">
                                            ...
                                            <a class="stretched-link text-body"
                                                ...
                                                <h6>{{ $category->nom }}
                                                    <small>({{ $category->produits_count }})</small>
                                                </h6>
                                            </a>
