            ...
            <div class="modal-content">
                ...
                <div class="row gx-0">
                    <div class="col-12 col-lg-5">
                        ...
                        <!-- Image -->
                        <img class="img-fluid" src="{{ asset('client/assets/img/covers/cover-25.jpg') }}" alt="...">
                ...
                <div class="container-fluid px-xl-0">
                    <div class="row align-items-center mx-xl-0">
                        <div class="col-12 col-lg-6 col-xl-5 py-4 py-xl-0 px-xl-0">
                            ...
                            <!-- Image -->
                            <img class="img-fluid" src="{{ asset('client/assets/img/products/product-7.jpg') }}" alt="...">

                            <!-- Button -->
                            <a class="btn btn-sm w-100 btn-primary" href="./product.html">
                                More Product Info <i class="fa fa-info ms-2"></i>
                            </a>
        ...
        <div class="offcanvas-body border-top fs-sm">
            ...
            <div class="row align-items-center position-relative mb-5">
                <div class="col-4 col-md-3">
                    ...
                    <!-- Image -->
                    <img class="img-fluid" src="{{ asset('client/assets/img/products/product-5.jpg') }}" alt="...">
            ...
            <div class="row align-items-center position-relative mb-5">
                <div class="col-4 col-md-3">
                    ...
                    <!-- Image -->
                    <img class="img-fluid" src="{{ asset('client/assets/img/products/product-6.jpg') }}" alt="...">
            ...
            <div class="row align-items-center position-relative mb-5">
                <div class="col-4 col-md-3">
                    ...
                    <!-- Image -->
                    <img class="img-fluid" src="{{ asset('client/assets/img/products/product-8.jpg') }}" alt="...">
            ...
            <div class="row align-items-center position-relative mb-5">
                <div class="col-4 col-md-3">
                    ...
                    <!-- Image -->
                    <img class="img-fluid" src="{{ asset('client/assets/img/products/product-9.jpg') }}" alt="...">
            ...
            <li class="list-group-item">
                <div class="row align-items-center">
                    <div class="col-4">
                        ...
                        <!-- Image -->
                        <a href="./product.html">
                            <img class="img-fluid" src="{{ asset('client/assets/img/products/product-10.jpg') }}" alt="...">
                        </a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 py-3">
                                ...
                                <ul class="list-styled fs-lg">
                                    ...
                                    <li class="list-styled-item">
                                        <a class="list-styled-link" href="./product-image-slider.html">Image
                                            Slider</a>
                                    </li>
                                    <li class="list-styled-item">
                            ...
                            <div class="col-12 py-3">
                                ...
                                <ul class="list-styled fs-lg">
                                    ...
                                    <li class="list-styled-item">
                                        <a class="list-styled-link" href="./account-payment-edit.html">Payment:
                                            New</a>
                                    </li>
                                    <li class="list-styled-item">
                ...
                <div class="modal-body">
                    <div class="row mb-6">
                        <div class="col-12 col-md-3">
                            ...
                            <!-- Image -->
                            <a href="./product.html">
                                <img class="img-fluid mb-7 mb-md-0" src="{{ asset('client/assets/img/products/product-6.jpg') }}"
                                    alt="...">
                            </a>
