                        ...
                        <div class="row mb-9">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-sm" id="checkoutBillingCompany"
                            ...
                            <table class="table table-bordered table-sm table-hover mb-0">
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="form-check custom-radio">
                                                <input class="form-check-input" id="checkoutShippingStandard"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check custom-radio">
                                                <input class="form-check-input" id="checkoutShippingFree"
                                                    name="shipping" type="radio">
                                                <label class="form-check-label text-body text-nowrap"
                            ...
                            <div class="collapse" id="checkoutShippingAddressCollapse">
                                <div class="row mt-6">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <!-- Address Line 1 -->
                                        <div class="form-group">
                                            <label class="form-label" for="checkoutShippingAddressLineOne">Address
                                                Line 1 *</label>
                                            <input class="form-control form-control-sm"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <!-- Address Line 2 -->
                                        <div class="form-group">
                                            <label class="form-label" for="checkoutShippingAddressLineTwo">Address
                                                Line 2</label>
                                            <input class="form-control form-control-sm"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="checkoutShippingAddressTown">Town / City
                                                *</label>
                                            <input class="form-control form-control-sm"
                                                id="checkoutShippingAddressTown" type="text"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="checkoutShippingAddressZIP">ZIP / Postcode
                                                *</label>
                                            <input class="form-control form-control-sm"
                                                id="checkoutShippingAddressZIP" type="text"
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <div class="input-group-append">
                                                <span class="input-group-text" data-bs-toggle="popover"
                                                    ...
                                                    <span><i class="fa fa-help-circle"></i></span>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="list-group-item">
                                ...
                                <div class="form-check custom-radio">
                                    ...
                                    <input class="form-check-input" id="checkoutPaymentPaypal" name="payment"
                                        type="radio" data-collapse="hide"
                                        data-target="#checkoutPaymentCardCollapse">

                                    <!-- Label -->
                                    <label class="form-check-label fs-sm text-body text-nowrap"
                                        for="checkoutPaymentPaypal">
                                        <img src="{{ asset('client/assets/img/brands/color/paypal.svg') }}"
                                            alt="...">
                                    </label>
