                ...
                <div class="col-12 col-md-3">
                    ...
                    <nav class="mb-10 mb-md-0">
                        <div class="list-group list-group-sm list-group-strong list-group-flush-x">
                            <a class="list-group-item list-group-item-action dropend-toggle active"
                                href="account-orders.html">
                                Orders
                            </a>
                            <a class="list-group-item list-group-item-action dropend-toggle "
                                    ...
                                    <div class="row gx-5 mb-4 mb-lg-0">
                                        <div class="col-3">
                                            ...
                                            <div class="ratio ratio-1x1 bg-cover"
                                                style="background-image: url({{ asset('client/assets/img/products/product-5.jpg') }});">
                                            </div>
                                    ...
                                    <div class="row gx-5">
                                        <div class="col-6">
                                            ...
                                            <a class="btn btn-sm w-100 btn-outline-dark"
                                                href="{{ route('client.account.order.details') }}">
                                                Order Details
                                            </a>
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="row gx-5 mb-4 mb-lg-0">
                                        <div class="col-3">
                                            ...
                                            <!-- Image -->
                                            <div class="ratio ratio-1x1 bg-cover"
                                                style="background-image: url({{ asset('client/assets/img/products/product-11.jpg') }});">
                                            </div>
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="row gx-5 mb-4 mb-lg-0">
                                        <div class="col-3">
                                            ...
                                            <!-- Image -->
                                            <div class="ratio ratio-1x1 bg-cover"
                                                style="background-image: url({{ asset('client/assets/img/products/product-14.jpg') }});">
                                            </div>
                                        ...
                                        <div class="col-3">
                                            ...
                                            <!-- Image -->
                                            <div class="ratio ratio-1x1 bg-cover"
                                                style="background-image: url({{ asset('client/assets/img/products/product-15.jpg') }});">
                                            </div>
